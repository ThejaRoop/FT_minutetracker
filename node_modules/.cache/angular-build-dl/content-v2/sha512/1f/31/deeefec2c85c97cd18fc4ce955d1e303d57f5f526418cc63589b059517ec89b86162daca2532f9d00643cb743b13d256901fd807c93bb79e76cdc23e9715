...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/stock-details-listing/stock-details-listing.component.html":
  /*!******************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/stock-details-listing/stock-details-listing.component.html ***!
    \******************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppStockDetailsListingStockDetailsListingComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "\n<form [formGroup]=\"queryForm\">\n    <input type=\"text\" formControlName=\"symbol\"/>\n<input type=\"date\" formControlName=\"fromDate\">\n<input type=\"date\" formControlName=\"toDate\">\n<button (click)=\"getDetails()\">Fetch Details</button>\n</form>\n\n<table *ngIf=\"showTable\">\n<tr>\n    <th></th>\n    <th colspan=\"3\" *ngFor=\"let date of datesArray; let i=index\">{{convertDateFormat(date)}}</th>\n</tr>\n<tr><th></th>\n    <ng-container *ngFor=\"let date of datesArray; let i=index\" > \n    <th>price</th>\n    <th>volume</th>\n    <th>price change</th>\n    </ng-container>\n</tr>\n<tr *ngFor=\"let item of [].constructor(noOfResponsesInDay); let j = index\">\n<ng-container>\n<td>{{calculateTime(datePricesMapping[0]['t'][j+1])}}</td>\n <ng-container *ngFor=\"let date of datesArray; let i=index\" > \n \n    <td>{{datePricesMapping[i]['c'][j+1]}}</td>\n    <td>{{datePricesMapping[i]['v'][j+1]}}</td>\n    <td>{{(datePricesMapping[i]['c'][j+1] - datePricesMapping[i]['c'][1]).toFixed(2)}}</td>\n    </ng-container>\n    </ng-container>\n</tr>\n\n</table>\n\n<p id=\"display\"></p>\n\n";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _stock_details_listing_stock_details_listing_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./stock-details-listing/stock-details-listing.component */
    "./src/app/stock-details-listing/stock-details-listing.component.ts");

    var routes = [{
      path: '',
      redirectTo: '/stockListing',
      pathMatch: 'full'
    }, {
      path: 'stockListing',
      component: _stock_details_listing_stock_details_listing_component__WEBPACK_IMPORTED_MODULE_6__["StockDetailsListingComponent"]
    }, {
      path: 'dashboard',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _stock_details_listing_stock_details_listing_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./stock-details-listing/stock-details-listing.component */
    "./src/app/stock-details-listing/stock-details-listing.component.ts");
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function ngOnInit() {
          this.getHeroes();
          this.heroService.getStockDetails().subscribe(function (res) {
  ...
  function srcAppHeroServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HeroService = /*#__PURE__*/function () {
      ...
      _createClass(HeroService, [{
        key: "getStockDetails",
        value: function getStockDetails() {
          return this.http.get('https://finnhub.io/api/v1/stock/candle?symbol=AAPL&resolution=1&from=1572651390&to=1572910590&token=brg4p17rh5rc8dj2rtj0').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractObserverData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getHeroes', [])));
        } // .pipe(catchError(this.dump.bind(this)))
        ...
        key: "extractObserverData",
        value: function extractObserverData(res) {
          console.log(res);
  ...
  /***/
  "./src/app/stock-details-listing/stock-details-listing.component.css":
  /*!***************************************************************************!*\
    !*** ./src/app/stock-details-listing/stock-details-listing.component.css ***!
    \***************************************************************************/
  ...
  /***/
  function srcAppStockDetailsListingStockDetailsListingComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "table {\r\n    border: 1px solid black;\r\n    border-collapse: collapse;\r\n}\r\nth, td {\r\n    border: 1px solid black;\r\n    padding: 3px;\r\n    text-align: center;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /*! exports provided: StockDetailsListingComponent */

  /***/
  function srcAppStockDetailsListingStockDetailsListingComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StockDetailsListingComponent", function () {
      return StockDetailsListingComponent;
    });
    /* harmony import */
    ...
    var _stock_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./stock-service.service */
    "./src/app/stock-details-listing/stock-service.service.ts");

    var StockDetailsListingComponent = /*#__PURE__*/function () {
      function StockDetailsListingComponent(fb, stockService) {
        _classCallCheck(this, StockDetailsListingComponent);

        this.fb = fb;
        this.stockService = stockService;
        this.timesArray = ['9:30', '9:35', '9:40'];
        this.datesArray = [];
        this.apiCalls = [];
      ...
      _createClass(StockDetailsListingComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this15 = this;
          ...
          this.queryForm.get('fromDate').valueChanges.subscribe(function (val) {
            _this15.fromDate = new Date(_this15.queryForm.get('fromDate').value);
          });
          this.queryForm.get('toDate').valueChanges.subscribe(function (val) {
            _this15.toDate = new Date(_this15.queryForm.get('toDate').value);
          });
        }
      }, {
        key: "getDetails",
        ...
        value: function getDates() {
          ...
          for (var i = 0; i < this.datesArray.length; i++) {// console.log(this.datesArray[i]);
          }
        ...
        value: function makeAPICalls() {
          ...
          this.apiCalls = [];
          this.noOfResponsesInDay = 0;
          this.datesArray.forEach(function (date) {
            var start, end, s, e;
            start = date;
            start.setHours(9);
            start.setMinutes(25);
            ...
            _this16.apiCalls.push(_this16.stockService.getStockDetails(_this16.queryForm.get('symbol').value, s, e));
          });
          Promise.all(this.apiCalls).then(function (result) {
            result.forEach(function (res, i) {
              _this16.datePricesMapping[i] = res;
            });
            console.log(_this16.datePricesMapping);
            _this16.noOfResponsesInDay = _this16.datePricesMapping[0]['c'].length - 1;
            _this16.showTable = true;
          });
        }
      }, {
        key: "calculateTime",
        value: function calculateTime(time) {
          var unix_timestamp = time; // Create a new JavaScript Date object based on the timestamp
        ...
        key: "calcBusinessDays",
        value: function calcBusinessDays(dDate1, dDate2) {
          var iWeeks,
              iDateDiff,
              iAdjust = 0;
        ...
        key: "ngAfterViewInit",
        value: function ngAfterViewInit() {// this.convertToXLSX(); 
        }
      }, {
        key: "convertToXLSX",
        value: function convertToXLSX() {
          var line = '';
          var a = {
            "c": [323.2, 320.79, 319, 300.61, 304.21],
            "h": [323.41, 323.28, 322.39, 312.15, 309.08],
            "l": [319.63, 319.36, 318.22, 300.01, 298.6],
            "o": [320.22, 320.3, 321.42, 311.46, 308.24],
            "s": "ok",
            "t": [1591623000, 1591709400, 1591795800, 1591882200, 1591968600],
            "v": [73641200, 77479200, 95000800, 209243600, 194529100]
          };
        ...
        key: "convertUNIXToDate",
        value: function convertUNIXToDate(ts) {
          var ts_ms = ts * 1000;
        ...
        value: function convertDateFormat(date_ob) {
          var year = date_ob.getFullYear();
          var month = ("0" + (date_ob.getMonth() + 1)).slice(-2);
          var date = ("0" + date_ob.getDate()).slice(-2);
          return year + "-" + month + "-" + date;
    ...
    StockDetailsListingComponent.ctorParameters = function () {
      return [{
        type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]
      }, {
        type: _stock_service_service__WEBPACK_IMPORTED_MODULE_3__["StockService"]
      }];
    };

    StockDetailsListingComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-stock-details-listing',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./stock-details-listing.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/stock-details-listing/stock-details-listing.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./stock-details-listing.component.css */
      "./src/app/stock-details-listing/stock-details-listing.component.css"))["default"]]
    })], StockDetailsListingComponent); // a='2020/06/15'
    // "2020/06/15"
    // new Date(a)
  ...
  /***/
  function srcAppStockDetailsListingStockServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var StockService = /*#__PURE__*/function () {
      ...
      _createClass(StockService, [{
        key: "getStockDetails",
        value: function getStockDetails(symbol, fromStamp, toStamp) {
          var _this17 = this;

          var resolution = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
          return new Promise(function (resolve, reject) {
            return _this17.http.get('https://finnhub.io/api/v1/stock/candle?symbol=' + symbol + '&resolution=' + resolution + '&from=' + fromStamp + '&to=' + toStamp + '&token=c68t22qad3ibppardpig').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(_this17.extractObserverData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(_this17.handleError('getHeroes', []))).subscribe(function (data) {
              resolve(data);
            }, function (err) {
              reject(err);
            });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/roop/Desktop/JS/stock_details_application/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
