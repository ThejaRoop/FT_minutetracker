...
AngularTestingModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AngularTestingModule });
AngularTestingModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AngularTestingModule_Factory(t) { return new (t || AngularTestingModule)(ɵngcc0.ɵɵinject(ɵngcc0.Injector)); }, providers: [{ provide: $INJECTOR, useFactory: $injectorFactory }] });
/** @nocollapse */
AngularTestingModule.ctorParameters = () => [
    { type: Injector }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularTestingModule, [{
        type: NgModule,
